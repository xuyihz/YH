...
%% 1.形态判断
% YH_Module_Shape_Est(Node_Coordinate, Num_Radial, Node_Itvl);
...
% 生成的APDL文件的路径
ANSYS_iFdir = '..\..\ANSYS\ANSYS_Files\1.Radial.ansys.txt';
% ANSYS模型的路径
...
YH_Module_Model(Node_Coordinate, Node_Support,...
    ...
    AREA, EM, MD,...
    ANSYS_JName, ANSYS_JTitle, ANSYS_iFdir);
% 生成APDL文件中SOLU部分
[EPEL_T_FN, EPEL_B_FN, Fext] = YH_Module_Solu_Radial(Num_Radial, Num_n1_n2, Node_Itvl,...
    ISTRAN, ERR_TOL, LSsteps,...
    ANSYS_iFdir);
% 自动调用ANSYS
status = YH_Module_RunANSYS(ANSYS_JName, ANSYS_Mdir, ANSYS_iFdir, ANSYS_oFdir);
