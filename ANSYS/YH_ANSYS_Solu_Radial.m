...
%% ANSYS APDL
fileID = fopen('..\..\ANSYS\ANSYS_Files\2.SOLU_Radial.ansys.txt','w');   % Open or create new file for writing. Discard existing contents, if any.
...
fprintf(fileID,'*IF, J, EQ, 1, THEN\n');    % if j == 1
% j == 1 为上索
fprintf(fileID,'*CFOPEN, 2.1EPEL_T, txt, , APPEND\n');  % *CFOPEN, Fname, Ext, --, Loc
fprintf(fileID,'*ELSE\n');    % else
% else 为下索
fprintf(fileID,'*CFOPEN, 2.2EPEL_B, txt, , APPEND\n');  % *CFOPEN, Fname, Ext, --, Loc
fprintf(fileID,'*ENDIF\n');    % end
