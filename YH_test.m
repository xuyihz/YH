...
fprintf(fileID,'DDELE, %d, ALL\n', iNo_N_des);  % 删除目标节点假想约束
fprintf(fileID,'FINISH\n');
...
fprintf(fileID,'*CFOPEN, USUM, txt\n');  % *CFOPEN, Fname, Ext, --, Loc
...
fprintf(fileID,'*GET, EPEL1, ELEM, %d, ETAB, EPELT\n', iNo_E_des1);    % 提取单元1应变(弦索1)
fprintf(fileID,'*GET, EPEL2, ELEM, %d, ETAB, EPELT\n', iNo_E_des2);    % 提取单元2应变(弦索2)
fprintf(fileID,'*GET, EPEL3, ELEM, %d, ETAB, EPELT\n', iNo_E_des3);    % 提取单元3应变(竖索)
...
fprintf(fileID,'INISTATE, SET, DTYP, EPEL\n');  % Strain data
% INISTATE, DEFINE, ID, EINT, KLAYER, PARMINT, Cxx, Cyy, Czz, Cxy, Cyz, Cxz
fprintf(fileID,'INISTATE, DEFINE, %d, , , , EPEL1\n', iNo_E_des1);
fprintf(fileID,'INISTATE, DEFINE, %d, , , , EPEL2\n', iNo_E_des2);
fprintf(fileID,'INISTATE, DEFINE, %d, , , , EPEL3\n', iNo_E_des3);
